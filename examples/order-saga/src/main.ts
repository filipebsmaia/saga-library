...
async function bootstrap() {
  ...
  console.log(
    "  POST /recurrings?paymentFail=true — Payment rejection → compensation",
  );
  console.log(
    "  POST /recurrings?transient=true   — Transient error → retry exhausted",
  );
  console.log(
    "  GET  /recurrings                  — List all recurring records",
  );
  ...
  console.log(
    "  POST /bulk-activations?lines=3    — Trigger bulk activation (1-10 lines)",
  );
  console.log(
    "  GET  /bulk-activations             — List all bulk activations",
  );
  console.log("\nObservability:");
