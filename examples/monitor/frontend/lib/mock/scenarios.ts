...
const compEvents: SagaEventDto[] = [
  ...
  generateSagaEvent(compRootId, compRootId, 2, compStarted, {
    sagaStepName: "capture-payment",
    sagaEventHint: "step",
    statusBefore: SagaStatus.RUNNING,
    statusAfter: SagaStatus.RUNNING,
  }),
  generateSagaEvent(compRootId, compRootId, 3, compStarted, {
    sagaStepName: "rollback-payment",
    sagaEventHint: "compensation",
    statusBefore: SagaStatus.RUNNING,
    statusAfter: SagaStatus.COMPENSATING,
  }),
  generateSagaEvent(compRootId, compRootId, 4, compStarted, {
    sagaStepName: "release-inventory",
    sagaEventHint: "compensation",
    statusBefore: SagaStatus.COMPENSATING,
    statusAfter: SagaStatus.COMPENSATING,
  }),
...
const forkEvents: SagaEventDto[] = [
  ...
  generateSagaEvent(
    ...
    forkRootId,
    0,
    new Date(forkStarted.getTime() + 4_000),
    {
      sagaParentId: forkRootId,
      sagaStepName: "locate-item",
      sagaEventHint: "step",
      statusAfter: SagaStatus.RUNNING,
    },
  ),
  ...
  generateSagaEvent(
    ...
    {
      sagaParentId: forkRootId,
      sagaStepName: "await-carrier-response",
      sagaEventHint: "step",
      statusBefore: SagaStatus.RUNNING,
      statusAfter: SagaStatus.RUNNING,
    },
...
const extraSagas: SagaStateDto[] = [
  generateSagaState({
    sagaId: "saga-extra-006",
    sagaRootId: "saga-extra-006",
    sagaName: "refund-processing",
    status: SagaStatus.COMPENSATING,
    currentStepName: "reverse-charge",
    lastEventHint: "compensation",
  ...
  generateSagaState({
    sagaId: "saga-extra-007",
    sagaRootId: "saga-extra-007",
    sagaName: "user-onboarding",
    status: SagaStatus.COMPLETED,
    currentStepName: "welcome-email",
    lastEventHint: "final",
  ...
  generateSagaState({
    sagaId: "saga-extra-008",
    sagaRootId: "saga-extra-008",
    sagaName: "notification-dispatch",
    status: SagaStatus.RUNNING,
    currentStepName: "send-push",
    lastEventHint: "step",
  ...
  generateSagaState({
    sagaId: "saga-extra-009",
    sagaRootId: "saga-extra-009",
    sagaName: "inventory-reservation",
    status: SagaStatus.RUNNING,
    currentStepName: "check-availability",
    lastEventHint: "step",
  ...
  generateSagaState({
    sagaId: "saga-extra-010",
    sagaRootId: "saga-extra-010",
    sagaName: "order-processing",
    status: SagaStatus.COMPLETED,
    currentStepName: "finalize-order",
    lastEventHint: "final",
